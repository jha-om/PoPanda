                ...
                <div className="mt-1 relative">
                    ...
                    <div className="absolute space-x-0.5 inset-y-0 right-0 flex items-center">
                        <Button
                            variant={"ghost"}
                            onClick={copyApiKey}
                            className="p-1 w-10 bg-gray-400/10 focus:outline-none focus:ring-2 focus:ring-brand-500"
                        >
                            {copySuccess ? (
                                <CheckIcon className="size-8 text-brand-900" />
                            ) : (
                                <ClipboardCopy className="size-8 text-brand-900" />
                            )}
                        </Button>
                    </div>
                </div>
