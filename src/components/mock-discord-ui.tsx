...
// line 3 and 5 will result into the same thing;
    ...
    return (
        <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
            ...
            <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
                ...
                <div
                    className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center cursor-pointer justify-center mb-3 hover:rounded-xl transition-all duration-200"
                >
                    <span className="text-lg font-semibold text-gray-400">
                        <Plus size="24" className="stroke-green-700 dark:stroke-green-500 transform group-hover:scale-125 transition duration-300" />
                    </span>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b boder-[#202225]">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="font-semibold text-white">PoPanda</p>
                    </div>
                ...
                {/* message history */}
                <div className="flex-1 overflow-y-auto p-4 bg-discord-background flex flex-col-reverse">{children}</div>
